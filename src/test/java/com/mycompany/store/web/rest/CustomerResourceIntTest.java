...
public class CustomerResourceIntTest {
    ...
    private static final Gender UPDATED_GENDER = Gender.FEMAL;

    private static final String DEFAULT_EMAIL = "B>@^S.z";
    private static final String UPDATED_EMAIL = "1S@D.Fr";
